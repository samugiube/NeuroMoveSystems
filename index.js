...
let vite = 3; let viteMax = 3; let cuoreImg
let forzaDx; let forzaSx
...
function preload() {
    playerImgDx = loadImage("./img/sci_dx.png")
    ...
    startImg = loadImage("./img/start_img.png")
    pausaImg = loadImage("./img/pausa_img.png")
